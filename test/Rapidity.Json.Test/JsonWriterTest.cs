...
namespace Rapidity.Json.Test
{
    public class JsonWriterTest
    {
            ...
            int count = 1;
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    using (var write = new JsonWriter(stringWriter))
                    {
                        write.WriteStartObject();
                        write.WritePropertyName("name\r\nname");
                        write.WriteString(" 特色为了开发了房间/卡拉\\文件");
                        write.WritePropertyName("text");
                        ...
                        write.WritePropertyName("url");
                        write.WriteString("http:\\/\\/wwww.baidu.com");
                        write.WritePropertyName("easpstring");
                        write.WriteString("\a\b\r\n\f\t\v\u5650\u231a\0\uffff\u0085\u2028\u2029\u5982\u679c");
            ...
            }
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    using (var write = new Newtonsoft.Json.JsonTextWriter(stringWriter))
                    {
                        ...
                        write.WriteStartObject();
                        write.WritePropertyName("name\r\nname");
                        write.WriteValue(" 特色为了开发了房间/卡拉\\文件");
        ...
        public void TextWriterTest()
        {
            ...
            {
                write.Write('\u2028');
                _output.WriteLine(write.ToString());
            }
        }
